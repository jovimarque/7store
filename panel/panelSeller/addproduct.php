                ...
                <div class="nig">
                    ...
                    <div class="menu-content">
                        ...
                        <div class="menu-content-items">
                            ...
                            <a href="historicovendas.php"> Historico de vendas</a>
                        </div>
                        ...
                        <div class="menu-content-items">
                            ...
                            <a href="product.php" class="clicked">Produtos</a>
                        </div>
                        ...
                        <div class="banner3-content">
                            <div class="banner3-content-cards">
                                <div class="banner3-content-cards-content">
                                    ...
                                    <p>Descrição</p>
                                    <input type="text" placeholder="Insira a descricao">

                                    <p>Preço</p>
                                    <input type="text" name="value" placeholder="Insira o preco">
                            ...
                            <div class="banner3-content-cards">
                                <div class="banner3-content-cards-content">
                                    ...
                                    <p>Nome</p>
                                    <input type="text" name="prodLogin" placeholder="Insira o nome">

                                    <p>Senha</p>
                                    <input type="text" name="prodPass" placeholder="Insira a senha">

                                    <p>Email (opcional)</p>
                                    <input type="text" placeholder="Insira o email">

                                    <p>Senha do email (opcional)</p>
                                    <input type="text" placeholder="Insira a senha do email">
