    ...
    <div class="cont-big-nig">
        ...
        <div class="container">
            ...
            <div class="banner-seller">
                <div class="banner-seller-content">
                    <h1>Adicione um produto</h1>
                    <button><a href="addproduct.php">Adicionar produto</a></button>
                </div>
            </div>
                    ...
                    <div class="banner3-content">
                        ...
                        <div class="banner3-content-cards">
                            ...
                            <div class="banner3-content-cards-content">
                                ...
                                <img src="../img/bannerproduto7s.png" alt="">
                                <h2><?php echo $product['name']; ?></h2>
                                <p>Descricao</p>
                                <h3>Preco: <span><?php echo $product['value']; ?></span></h3>
                                <a class="text-left-start-btn" href="">EDITAR</a>
                                <a class="text-left-start-btn" href="">REMOVER</a>
